...
var routes = [
    ...
    {
        path: 'new',
        loadChildren: function () { return __webpack_require__.e(/*! import() | Pages-create-task-create-task-module */ "Pages-create-task-create-task-module").then(__webpack_require__.bind(null, /*! ../../Pages/create-task/create-task.module */ "./src/app/Pages/create-task/create-task.module.ts")).then(function (m) { return m.CreateTaskPageModule; }); }
    }
];
...
var Tab3Page = /** @class */ (function () {
    ...
    Tab3Page.prototype.getAllTasks = function () {
        var _this = this;
    ...
    Tab3Page.prototype.getInprogress = function () {
        var _this = this;
        this.userProgress = new Array();
        this.userProgress = this.loadedTasks
            .filter(function (x) { return _this.parsPercentage(x.progress) < 100; })
            .slice();
    };
    Tab3Page.prototype.getCompleted = function () {
        var _this = this;
        this.userProgress = new Array();
        this.userProgress = this.loadedTasks
            .filter(function (x) { return _this.parsPercentage(x.progress) >= 100; })
