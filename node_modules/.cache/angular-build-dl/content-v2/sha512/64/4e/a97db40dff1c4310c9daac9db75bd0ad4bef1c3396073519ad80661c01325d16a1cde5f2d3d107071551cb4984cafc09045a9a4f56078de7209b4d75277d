...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["login-login-module"], {
  ...
  function srcAppPagesLoginLoginPageTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var LoginPage = /*#__PURE__*/function () {
      function LoginPage(auth, userServ) {
        var _this = this;
      ...
      _createClass(LoginPage, [{
        key: "ngOnInit",
        value: function ngOnInit() {// this.authServ.auth.sharedUser.subscribe((user) => (this.email = user));
                ...
                switch (_context.prev = _context.next) {
                  case 0:
                    ...
                    return new Promise(function () {
                      ...
                      setTimeout(function () {
                        try {
                          _this2.auth.signIn(_this2.email, _this2.pass);

                          _this2.auth.userChange.emit(_this2.auth.getLoggedUser());
