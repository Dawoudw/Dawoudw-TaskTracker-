...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["user-tasks-user-tasks-module"], {
  ...
  /***/
  function srcAppPagesUserTasksUserTasksRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "UserTasksRoutingModule", function () {
    ...
    var _user_tasks_page__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    /*! ./user-tasks.page */
    ...
    var UserTasksRoutingModule = function UserTasksRoutingModule() {
      _classCallCheck(this, UserTasksRoutingModule);
    };

    UserTasksRoutingModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
  ...
  /***/
  function srcAppPagesUserTasksUserTasksModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "UserTasksModule", function () {
    ...
    var _Pages_user_tasks_user_tasks_routing_module__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    /*! ../../Pages/user-tasks/user-tasks-routing.module */
    "./src/app/Pages/user-tasks/user-tasks-routing.module.ts");
    /* harmony import */


    var _Pages_user_tasks_user_tasks_page__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
    /*! ../../Pages/user-tasks/user-tasks.page */
    "./src/app/Pages/user-tasks/user-tasks.page.ts");

    var UserTasksModule = function UserTasksModule() {
      _classCallCheck(this, UserTasksModule);
    };

    UserTasksModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
      imports: [_ionic_angular__WEBPACK_IMPORTED_MODULE_1__["IonicModule"], _angular_common__WEBPACK_IMPORTED_MODULE_3__["CommonModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_4__["FormsModule"], _Pages_user_tasks_user_tasks_routing_module__WEBPACK_IMPORTED_MODULE_5__["UserTasksRoutingModule"]],
      ...
      _createClass(UserTasksPage, [{
        ...
        value: function getUserTasks() {
          ...
          this.activeroute.paramMap.subscribe(function (param) {
            ...
            _this.user.userId = userid; // console.log(userid);
        ...
        value: function getTotalInProgress() {
          ...
          return this.userProgress.filter(function (x) {
            return _this2.parsPercentage(x.progress) < 100;
          }).slice().length;
        }
      }, {
        ...
        value: function getTotalCompleted() {
          ...
          return this.userProgress.filter(function (x) {
            return _this3.parsPercentage(x.progress) >= 100;
          }).slice().length;
        }
      }, {
        key: "parsPercentage",
...
//# sourceMappingURL=user-tasks-user-tasks-module-es5.js.map