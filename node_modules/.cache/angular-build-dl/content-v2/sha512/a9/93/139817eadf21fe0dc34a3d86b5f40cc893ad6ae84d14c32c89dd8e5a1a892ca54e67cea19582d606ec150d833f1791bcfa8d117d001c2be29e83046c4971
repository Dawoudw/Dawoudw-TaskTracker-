...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["home-home-module"], {
  ...
  function srcAppPagesHomeHomePageTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var HomePage = /*#__PURE__*/function () {
      function HomePage(router, navCtrl, auth, chatService, db, report) {
        var _this = this;
        ...
        this.TodayTasks = new Array();
        this.report.getTasksToday().then(function (resolve) {
          _this.TodayTasks = resolve;
          console.log("getTasksToday resolve", _this.TodayTasks);
        });
      ...
      _createClass(HomePage, [{
        ...
        value: function ngOnInit() {
          console.log("arrived on home page"); //if logged in then checkOrCreateUserInFirebase() else openlogin
          // this.openlogin();
        ...
        key: "checkOrCreateUserInFirebase",
        value: function checkOrCreateUserInFirebase() {
          var _this2 = this;
            ...
            try {
              for (_iterator.s(); !(_step = _iterator.n()).done;) {
                ...
                if (data.length > 0) {
                  ...
                  _this2.chatService.currentUserIdFromFirebaseSetFromHomePage = data[0].id; // localStorage.setItem(data[0].id, "userIdFirebase");

                  localStorage.setItem("clientIdFirebase", JSON.stringify(data[0].id)); // this.groupId = data[0].id;
                  ...
                  _this2.db.collection('usersTaskTracker').add({
                    email: _this2.auth.getLoggedUser().email,
                    userId: _this2.auth.getLoggedUser().userId,
                    userName: _this2.auth.getLoggedUser().userName,
                    avatar: _this2.auth.getLoggedUser().avatar
                  });
                }
              }
            } catch (err) {
