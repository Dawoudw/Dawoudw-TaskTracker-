...
const routes = [
    ...
    {
        path: ":repid",
        loadChildren: () => __webpack_require__.e(/*! import() | Pages-report-report-module */ "Pages-report-report-module").then(__webpack_require__.bind(null, /*! ../../Pages/report/report.module */ "./src/app/Pages/report/report.module.ts")).then((m) => m.ReportPageModule),
    },
];
