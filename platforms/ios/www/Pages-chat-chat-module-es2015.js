...
let ChatPage = class ChatPage {
    constructor(route, chatService, router, camera) {
        this.route = route;
    ...
    ngOnInit() {
        ...
        this.route.params.subscribe(data => {
            ...
            this.chatService.getOneGroup(data.id).subscribe(res => {
                ...
                this.messages = this.chatService.getChatMessages(this.chat.id).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["map"])(messages => {
