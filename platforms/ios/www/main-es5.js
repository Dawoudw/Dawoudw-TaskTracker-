...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function $$_lazy_route_resourceLazyRecursive(module, exports, __webpack_require__) {
    var map = {
      "../create-subtask/create-subtask.module": ["./src/app/Pages/create-subtask/create-subtask.module.ts", "common", "create-subtask-create-subtask-module"],
      "../group-chat/group-chat.module": ["./src/app/Pages/group-chat/group-chat.module.ts", "common", "group-chat-group-chat-module"],
      ...
      "../task-subview/task-subview.module": ["./src/app/Pages/task-subview/task-subview.module.ts", "common", "task-subview-task-subview-module"],
      "../team-progress/team-progress.module": ["./src/app/Pages/team-progress/team-progress.module.ts", "team-progress-team-progress-module"],
      "./Pages/home/home.module": ["./src/app/Pages/home/home.module.ts", "common", "home-home-module"],
      "./Pages/login/login.module": ["./src/app/Pages/login/login.module.ts", "Pages-login-login-module"],
      "./Pages/tabs/tabs.module": ["./src/app/Pages/tabs/tabs.module.ts", "common", "Pages-tabs-tabs-module"]
    };
    ...
    var CreateTaskPage = /*#__PURE__*/function () {
      ...
      _createClass(CreateTaskPage, [{
        ...
        value: function onCreateTask() {
          ...
          this.form.reset();
          this.modalCtrl.dismiss(null, 'task created'); // window.location.replace('tasktracker/mytasks')
        }
      }]);
    ...
    var AuthService = /*#__PURE__*/function () {
      ...
      _createClass(AuthService, [{
        ...
        value: function redirectToHome() {
          ...
          window.location.replace("tasktracker/home"); //this.router.navigate["/"];
        }
      }, {
        key: "redirectToLogin",
        value: function redirectToLogin() {
          // if (!this.checkCurrentUser())
          this.navCtrl.navigateRoot("login"); // this.router.navigate["login"];
    ...
    var ReportService = /*#__PURE__*/function () {
      ...
      _createClass(ReportService, [{
        ...
        value: function getTasksToday() {
          return this.httpClient.get("".concat(this.path, "/task/today")).toPromise();
        }
      }]);
      ...
      _createClass(TasksService, [{
        ...
        */
        ...
        value: function getSubTasks(taskId) {
          return this.httpClient.get("".concat(this.path, "/task?subtask=").concat(taskId)).toPromise();
        }
        /*
        ...
        */
        ...
        key: "addSubTask",
        value: function addSubTask(id, subTask) {
          return this.httpClient.post("".concat(this.path, "/task/").concat(id), subTask).toPromise();
        }
      }, {
        key: "addTask",
  ...
  /***/
  function srcAppServicesThemeServiceServiceTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var ThemeService = /*#__PURE__*/function () {
      ...
      _createClass(ThemeService, [{
        ...
        key: "enableLightMode",
        value: function enableLightMode() {
    ...
    ThemeService = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
      providedIn: "root"
    }), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__param"])(1, Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Inject"])(_angular_common__WEBPACK_IMPORTED_MODULE_2__["DOCUMENT"]))], ThemeService);
    /***/
  },
            ...
            return regeneratorRuntime.wrap(function _callee$(_context) {
              while (1) {
                switch (_context.prev = _context.next) {
                  ...
                  case 5:
                    console.log("usersList", users); // console.log("usersAr", this.usersList);
  ...
  function srcAppAppComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _Services_theme_service_service__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(
    /*! ./Services/theme-service.service */
    "./src/app/Services/theme-service.service.ts");
    ...
    var AppComponent = /*#__PURE__*/function () {
      ...
      platform, splashScreen, statusBar, auth, menuCtr, router, modalCtrl, navCtrl, menu, actionSheetCtrl, toastCtr, iab, themeServ) {
        ...
        this.initializeApp(); // this.backButtonEvent();
      ...
      _createClass(AppComponent, [{
        ...
        value: function openTeamProgress() {
          window.location.replace("tasktracker/team-progress"); //this.navCtrl.navigateRoot("tasktracker/team-progress");
        }
      }, {
        key: "openWebSiteApp",
        value: function openWebSiteApp() {
        ...
        value: function changeTheme(e) {
          ...
          e.target.checked ? this.themeServ.enableDarkMode() : this.enableLightTheme();
        }
      }, {
        key: "enableDarkTheme",
        value: function enableDarkTheme() {}
      }, {
        key: "enableLightTheme",
        value: function enableLightTheme() {
        ...
        value: function backButtonEvent() {
          ...
          this.platform.backButton.subscribe(function () {
            return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(_this11, void 0, void 0, /*#__PURE__*/regeneratorRuntime.mark(function _callee5() {
              ...
              var element, _element, _element2;
  ...
  function srcAppAppModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _Services_authService_service__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(
    /*! ./Services/authService.service */
    "./src/app/Services/authService.service.ts");
    /* harmony import */
    ...
    var _Services_tasks_service__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(
    /*! ./Services/tasks.service */
    "./src/app/Services/tasks.service.ts");
    /* harmony import */


    var _Services_report_service__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(
    /*! ./Services/report.service */
    "./src/app/Services/report.service.ts");
    /* harmony import */


    var _Services_task_progress_service_service__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(
    /*! ./Services/task-progress-service.service */
    "./src/app/Services/task-progress-service.service.ts");
    /* harmony import */


    var _Services_theme_service_service__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(
    /*! ./Services/theme-service.service */
    "./src/app/Services/theme-service.service.ts");
    /* harmony import */
    ...
    AppModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
      ...
      entryComponents: [],
      imports: [_angular_platform_browser__WEBPACK_IMPORTED_MODULE_3__["BrowserModule"], _ionic_angular__WEBPACK_IMPORTED_MODULE_6__["IonicModule"].forRoot(), _angular_common__WEBPACK_IMPORTED_MODULE_5__["CommonModule"], _app_routing_module__WEBPACK_IMPORTED_MODULE_11__["AppRoutingModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormsModule"], _ionic_angular__WEBPACK_IMPORTED_MODULE_6__["IonicModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_2__["ReactiveFormsModule"], _angular_common_http__WEBPACK_IMPORTED_MODULE_10__["HttpClientModule"], _angular_fire__WEBPACK_IMPORTED_MODULE_20__["AngularFireModule"].initializeApp(_environments_environment__WEBPACK_IMPORTED_MODULE_21__["environment"].firebase), _angular_fire_firestore__WEBPACK_IMPORTED_MODULE_22__["AngularFirestoreModule"], _angular_fire_auth__WEBPACK_IMPORTED_MODULE_23__["AngularFireAuthModule"], // FirestoreSettingsToken,
      _angular_fire_storage__WEBPACK_IMPORTED_MODULE_24__["AngularFireStorageModule"]],
      providers: [_ionic_native_status_bar_ngx__WEBPACK_IMPORTED_MODULE_9__["StatusBar"], _ionic_native_splash_screen_ngx__WEBPACK_IMPORTED_MODULE_8__["SplashScreen"], _ionic_native_in_app_browser_ngx__WEBPACK_IMPORTED_MODULE_7__["InAppBrowser"], _Services_authService_service__WEBPACK_IMPORTED_MODULE_14__["AuthService"], _Services_users_service__WEBPACK_IMPORTED_MODULE_15__["UsersService"], _Services_tasks_service__WEBPACK_IMPORTED_MODULE_16__["TasksService"], _Services_theme_service_service__WEBPACK_IMPORTED_MODULE_19__["ThemeService"], _Services_task_progress_service_service__WEBPACK_IMPORTED_MODULE_18__["TaskProgressService"], _Services_report_service__WEBPACK_IMPORTED_MODULE_17__["ReportService"], _ionic_native_camera_ngx__WEBPACK_IMPORTED_MODULE_25__["Camera"], //  { provide: Camera, useClass: CameraMock },
  ...
  function _(module, exports, __webpack_require__) {
    ...
    /*! /Users/tejasramani/Other-webdev/ionic/Task-Tracker-Dev20200826/src/main.ts */
    "./src/main.ts");
    /***/
  }
}, [[0, "runtime", "vendor"]]]);
