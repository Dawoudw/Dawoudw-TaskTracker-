  ...
  function srcAppPagesChatChatPageTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var ChatPage = /*#__PURE__*/function () {
      function ChatPage(route, chatService, router, camera) {
        ...
        this.camera = camera;
        this.newMsg = '';
        this.chatTitle = ''; // currentUserId = this.chatService.currentUserIdFromFirebaseSetFromHomePage;
        // currentUserId = JSON.parse(localStorage.getItem("clientIdFirebase"));

        this.currentUserId = this.chatService.currentUserIdFromFireabase;
        this.chat = null;
      }
      ...
      _createClass(ChatPage, [{
        ...
        value: function ngOnInit() {
          ...
          console.log("this.currentUserId on chat page =" + this.currentUserId); // //scroll to bottom on init
        ...
        value: function sendFileCamera() {
          ...
          this.camera.getPicture(options).then(function (data) {
            var obj = _this4.chatService.addFileMessage(data, _this4.chat.id);

            var task = obj.task;
            task.then(function (res) {
              obj.ref.getDownloadURL().subscribe(function (url) {
                _this4.chatService.saveFileMessage(url, _this4.chat.id);
              });
            });
    ...
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_3__["ViewChild"])(_ionic_angular__WEBPACK_IMPORTED_MODULE_5__["IonContent"])], ChatPage.prototype, "content", void 0);
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_3__["ViewChild"])('input', {
