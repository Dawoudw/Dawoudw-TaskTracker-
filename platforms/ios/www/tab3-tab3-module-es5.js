...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["tab3-tab3-module"], {
  ...
  function srcAppPagesTab3Tab3RoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var routes = [{
      ...
      loadChildren: function loadChildren() {
        return Promise.all(
        /*! import() | Pages-create-task-create-task-module */
        [__webpack_require__.e("common"), __webpack_require__.e("Pages-create-task-create-task-module")]).then(__webpack_require__.bind(null,
        /*! ../../Pages/create-task/create-task.module */
        "./src/app/Pages/create-task/create-task.module.ts")).then(function (m) {
          return m.CreateTaskPageModule;
        });
      }
    }];
