...
let CreateTaskPage = class CreateTaskPage {
    constructor(modalCtrl, tasksService) {
...
const userPool = new amazon_cognito_identity_js__WEBPACK_IMPORTED_MODULE_2__["CognitoUserPool"](poolData);
let AuthService = class AuthService {
    constructor(navCtrl, router, userServ) {
    ...
    register(email, password) {
        const attributeList = [];
        return new zen_observable__WEBPACK_IMPORTED_MODULE_3___default.a((observer) => {
    ...
    confirmAuthCode(code) {
        ...
        return new zen_observable__WEBPACK_IMPORTED_MODULE_3___default.a((observer) => {
            const cognitoUser = new amazon_cognito_identity_js__WEBPACK_IMPORTED_MODULE_2__["CognitoUser"](user);
    ...
    signIn(email, password) {
        ...
        const authenticationDetails = new amazon_cognito_identity_js__WEBPACK_IMPORTED_MODULE_2__["AuthenticationDetails"](authenticationData);
        const userData = {
            Username: email,
            Pool: userPool,
        };
        const cognitoUser = new amazon_cognito_identity_js__WEBPACK_IMPORTED_MODULE_2__["CognitoUser"](userData);
        new zen_observable__WEBPACK_IMPORTED_MODULE_3___default.a((observer) => {
    ...
    getAuthenticatedUser() {
        ...
        if (this.isLoggedIn()) {
            let usr = new Promise((resolve) => {
                ...
                return new _Models_user__WEBPACK_IMPORTED_MODULE_4__["User"](usr.userId, usr.userName, usr.email, usr.avatar);
    ...
    getLoggedUser() {
        ...
        let client = new _Models_user__WEBPACK_IMPORTED_MODULE_4__["User"]();
...
let TaskProgressService = class TaskProgressService {
    constructor(taskServ, userServ) {
    ...
    ngOnInit() { }
    getTasksGroupByUserId() {
        let avg = 0;
        let counter = 0;
        let self = this;
        let up;
        let usertasksAry = new Array();
        const userstasks$ = this.taskServ
            .getAllTasks()
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["switchMap"])((res) => res));
        const srs$ = userstasks$.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["groupBy"])((t) => t.userid), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["mergeMap"])((gr) => gr.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["toArray"])())));
        srs$.subscribe((val) => {
...
TaskProgressService.ctorParameters = () => [
...
let TasksService = class TasksService {
    ...
    fetchMyTasks(userId) {
        ...
        }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])((tasks) => {
    ...
    getTask(id) {
        return this.httpClient
            ...
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])((taskData) => {
    ...
    */
    ...
    addTask(taskTitle, taskDescription) {
        ...
        const newTask = Object.create(_Models_task__WEBPACK_IMPORTED_MODULE_2__["Task"]);
        ...
        return this.httpClient
            ...
            return this.myTasks;
        }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["take"])(1), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])((tasks) => {
    ...
    updateTask(task) {
        ...
        return this.myTasks.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["take"])(1), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["switchMap"])((tasks) => {
        ...
        }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["switchMap"])((tasks) => {
            ...
            return this.httpClient.put(`https://46odim7l6f.execute-api.us-east-2.amazonaws.com/beta/task`, 
...
let UsersService = class UsersService {
    ...
    getAllUsers() {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            let users = yield this.http.get(`${this.path}/id/`).toPromise();
            yield users.forEach((u) => {
                this.usersList.push(new _Models_user__WEBPACK_IMPORTED_MODULE_3__["User"](u.id, u.name, u.email, "../assets/avatar.svg"));
            });
    ...
    getUserById(id) {
        let rs = this.http.get(`${this.path}/id/${id}`).toPromise();
        let usr = new _Models_user__WEBPACK_IMPORTED_MODULE_3__["User"]();
        rs.then((res) => {
            console.log("res", res);
...
let AppComponent = class AppComponent {
    ...
    openWebSiteApp() {
        let url = `http://taskapp-lti.s3-website.us-east-2.amazonaws.com/home`;
    ...
    backButtonEvent() {
        this.platform.backButton.subscribe(() => Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            ...
            // close side menua
            try {
                const element = yield this.menu.getOpen();
                if (element !== null) {
                    this.menu.close();
                    return;
                }
