...
let TodayTasksComponent = class TodayTasksComponent {
    constructor(repServ, usrServ, auth) {
...
TodayTasksComponent.ctorParameters = () => [
...
let TeamProgressPage = class TeamProgressPage {
    constructor(datasev, repServ, usrServ, taskServ, auth) {
        ...
        this.repServ.getTasks().subscribe((data) => {
            ...
            new Promise((resolve) => {
                ...
                for (let id of Object.keys(res[0])) {
                    let up = new src_app_Models_user_progress__WEBPACK_IMPORTED_MODULE_2__["UserProgress"]();
                    let totaltasks = 0;
                    let totalInProgress = 0;
                    let totalInCompeletd = 0;
                    let avgProgress = 0;
                    let taskid = "";
                    up.userId = id;
...
let UserTasksPage = class UserTasksPage {
    ...
    constructor(datasev, activeroute, aut, usrServ, taskServ, navCtr) {
        this.datasev = datasev;
